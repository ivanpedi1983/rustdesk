...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használata során. A megfelelő működés érdekében, kérem telepítse a HkRemoto alkalmazást a számítógépre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a HkRemoto-nek \"Kisegítő lehetőség\" engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [HkRemoto Input] szolgáltatást."),
        ...
        ("Quit", "Kilépés"),
        ("doc_mac_permission", "https://HkRemoto.com/docs/hu/manual/mac/#enable-permissions"),
        ("Help", "Segítség"),
        ("Failed", "Sikertelen"),
        ("Succeeded", "Sikeres"),
        ...
        ("Language", "Nyelv"),
        ("Keep HkRemoto background service", "HkRemoto futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívűl hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a HkRemoto alkalmazás beállítási oldalára, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ("Start on Boot", ""),
        ...
        ("Show HkRemoto", "A HkRemoto megjelenítése"),
