...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na HkRemoto mrežu..."),
        ...
        ("install_tip", "Zbog UAC HkRemoto ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate HkRemoto na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, HkRemoto-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, HkRemoto-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite HkRemoto-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [HkRemoto Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep HkRemoto background service", "Zadrži HkRemoto kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje HkRemoto aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on Boot", ""),
        ...
        ("Show HkRemoto", "Prikazi HkRemoto"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
