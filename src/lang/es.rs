...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red HkRemoto en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que HkRemoto no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar HkRemoto a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a HkRemoto de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a HkRemoto de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del mouse o toque, debe permitir que HkRemoto use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [HkRemoto Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep HkRemoto background service", "Dejar HkRemoto como Servicio en 2do plano"),
        ...
        ("Show HkRemoto", "Mostrar HkRemoto"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a HkRemoto permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a HkRemoto permisos de \"Grabar Audio\"."),
        ...
        ("confirm_idd_driver_tip", "La opción de instalar el controlador de pantalla virtual está marcada. Hay que tener en cuenta que se instalará un certificado de prueba para confirar en el controlador de pantalla. Este certificado solo se usará para confiar en controladores HkRemoto."),
        ...
        ("verify_HkRemoto_password_tip", "Verificar la contraseña de HkRemoto"),
