...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі HkRemoto..."),
        ...
        ("install_tip", "Через UAC в деяких випадках HkRemoto може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення HkRemoto в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати HkRemoto дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати HkRemoto дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити HkRemoto використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [HkRemoto Input]."),
        ...
        ("Language", "Мова"),
        ("Keep HkRemoto background service", "Зберегти фонову службу HkRemoto"),
        ...
        ("Show HkRemoto", "Показати HkRemoto"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати HkRemoto дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати HkRemoto дозвіл на \"Запис аудіо\""),
        ...
        ("confirm_idd_driver_tip", "Позначено встановлення драйвера віртуального дисплея. Зважайте, що буде встановлено тестовий сертифікат для засвідчення драйвера віртуального дисплея. Цей тестовий сертифікат буде використовуватись лише для засвідчення драйверів HkRemoto."),
        ...
        ("verify_HkRemoto_password_tip", "Перевірте пароль HkRemoto"),
