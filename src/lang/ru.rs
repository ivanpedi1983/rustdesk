...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети HkRemoto..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC HkRemoto может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже, чтобы установить HkRemoto в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить HkRemoto права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить HkRemoto права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить HkRemoto использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"HkRemoto Input\"."),
        ...
        ("Quit", "Выйти"),
        ("doc_mac_permission", "https://HkRemoto.com/docs/ru/manual/mac/#включение-разрешений"),
        ("Help", "Помощь"),
        ("Failed", "Не выполнено"),
        ("Succeeded", "Выполнено"),
        ...
        ("Language", "Язык"),
        ("Keep HkRemoto background service", "Держать в фоне службу HkRemoto"),
        ...
        ("Show HkRemoto", "Показать HkRemoto"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить HkRemoto разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить HkRemoto разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске HkRemoto."),
        ...
        ("confirm_idd_driver_tip", "Включена функция установки драйвера виртуального дисплея. Обратите внимание, что для доверия к драйверу будет установлен тестовый сертификат. Этот сертификат будет использоваться только для подтверждения доверия драйверам HkRemoto."),
        ...
        ("verify_HkRemoto_password_tip", "Подтвердить пароль HkRemoto"),
