...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the HkRemoto network..."),
        ...
        ("install_tip", "Due to UAC, HkRemoto can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install HkRemoto to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant HkRemoto \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant HkRemoto \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow HkRemoto to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [HkRemoto Input] service."),
        ...
        ("doc_mac_permission", "https://HkRemoto.com/docs/en/manual/mac/#enable-permissions"),
        ("doc_fix_wayland", "https://HkRemoto.com/docs/en/manual/linux/#x11-required"),
        ("server_not_support", "Not yet supported by the server"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next HkRemoto application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant HkRemoto \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running HkRemoto."),
        ("config_microphone", "In order to speak remotely, you need to grant HkRemoto \"Record Audio\" permissions."),
        ...
        ("confirm_idd_driver_tip", "The option to install the virtual display driver is checked. Note that a test certificate will be installed to trust the virtual display driver. This test certificate will only be used to trust HkRemoto drivers."),
        ...
        ("enter_HkRemoto_passwd_tip", "Enter HkRemoto password"),
        ("remember_HkRemoto_passwd_tip", "Remember HkRemoto password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_HkRemoto_password_tip", "Verify HkRemoto password"),
