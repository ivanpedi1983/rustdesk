...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau HkRemoto..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à HkRemoto."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à HkRemoto l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser HkRemoto à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [HkRemoto Input]."),
        ...
        ("Quit", "Quitter"),
        ("doc_mac_permission", "https://HkRemoto.com/docs/fr/manual/mac/#enable-permissions"),
        ("Help", "Aider"),
        ("Failed", "échouer"),
        ("Succeeded", "Succès"),
        ...
        ("Language", "Langue"),
        ("Keep HkRemoto background service", "Gardez le service HkRemoto en arrière plan"),
        ...
        ("Show HkRemoto", "Afficher HkRemoto"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à HkRemoto l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à HkRemoto les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de HkRemoto en cours d'éxécution."),
        ...
        ("confirm_idd_driver_tip", "L'option d'installation du pilote d'affichage virtuel est cochée. Notez qu'un certificat de test sera installé pour faire confiance au pilote d'affichage virtuel. Ce certificat de test ne sera utilisé que pour faire confiance aux pilotes HkRemoto."),
        ...
        ("verify_HkRemoto_password_tip", "Vérifier le mot de passe HkRemoto"),
