...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, HkRemoto bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, HkRemoto'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için HkRemoto'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için HkRemoto'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, HkRemoto'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [HkRemoto Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep HkRemoto background service", "HkRemoto arka plan hizmetini sürdürün"),
        ...
        ("Show HkRemoto", "HkRemoto'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
