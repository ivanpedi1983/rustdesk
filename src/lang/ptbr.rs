...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do HkRemoto..."),
        ...
        ("install_tip", "Devido ao UAC, o HkRemoto não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o HkRemoto no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao HkRemoto permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao HkRemoto permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o HkRemoto use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [HkRemoto Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep HkRemoto background service", "Manter o serviço do HkRemoto executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do HkRemoto."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do HkRemoto."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do HkRemoto."),
        ...
        ("confirm_idd_driver_tip", "A opção para instalar o driver de exibição virtual está marcada. Observe que um certificado de teste será instalado para confiar no driver de vídeo virtual. Este certificado de teste será usado apenas para confiar nos drivers HkRemoto."),
        ...
        ("verify_HkRemoto_password_tip", "Verifique a senha do HkRemoto"),
