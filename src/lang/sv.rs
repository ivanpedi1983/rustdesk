...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till HkRemoto..."),
        ...
        ("install_tip", "På grund av UAC, kan inte HkRemoto fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera HkRemoto på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge HkRemoto \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge HkRemoto \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [HkRemoto Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep HkRemoto background service", "Behåll HkRemoto i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa HkRemoto programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
