...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 HkRemoto 網路 ..."),
        ("Enable Service", "啟用服務"),
        ("Start Service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 HkRemoto 在某些情況下無法正常以遠端電腦執行。若要避開 UAC，請點擊下方按鈕將 HkRemoto 安裝到系統中。"),
        ("Click to upgrade", "點擊以升級"),
        ("Click to download", "點擊以下載"),
        ("Click to update", "點擊以更新"),
        ("Configure", "設定"),
        ("config_acc", "您需要授予 HkRemoto「協助工具」權限才能存取遠端電腦。"),
        ("config_screen", "您需要授予 HkRemoto「畫面錄製」權限才能存取遠端電腦。"),
        ("Installing ...", "正在安裝 ..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip2", "請在接下來的系統設定頁面中，找到並進入「已安裝的服務」頁面，並將「HkRemoto Input」服務開啟"),
        ...
        ("Quit", "退出"),
        ("doc_mac_permission", "https://HkRemoto.com/docs/zh-tw/manual/mac/#啟用權限"),
        ("Help", "幫助"),
        ("Failed", "失敗"),
        ("Succeeded", "成功"),
        ...
        ("Language", "語言"),
        ("Keep HkRemoto background service", "保持 HkRemoto 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如需關閉此功能，請在接下來的 HkRemoto 應用設定頁面中，找到並進入 [電源] 頁面，取消勾選 [不受限制]"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 HkRemoto \"輸入監控\" 權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 HkRemoto \"錄音\"權限。"),
        ...
        ("confirm_idd_driver_tip", "安裝虛擬顯示器驅動程式的選項已勾選。請注意，測試證書將被安裝以信任虛擬顯示器驅動。測試證書僅會用於信任 HkRemoto 的驅動程式。"),
        ("RDP Settings", "RDP 設定"),
        ("Sort by", "排序方式"),
        ("New Connection", "新連線"),
        ("Restore", "還原"),
        ...
        ("verify_HkRemoto_password_tip", "驗證 HkRemoto 密碼"),
