...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem HkRemoto-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann HkRemoto in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren HkRemoto auf dem System."),
        ("Click to upgrade", "Upgrade"),
        ("Click to download", "Zum Herunterladen klicken"),
        ("Click to update", "Update"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie HkRemoto Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie HkRemoto die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie HkRemoto erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"HkRemoto Input\" ein."),
        ...
        ("Quit", "Beenden"),
        ("doc_mac_permission", "https://HkRemoto.com/docs/de/manual/mac/#berechtigungen-aktivieren"),
        ("Help", "Hilfe"),
        ...
        ("Language", "Sprache"),
        ("Keep HkRemoto background service", "HkRemoto im Hintergrund ausführen"),
        ...
        ("Show HkRemoto", "HkRemoto anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie HkRemoto die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie HkRemoto die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von HkRemoto auf \"Ja\" klicken."),
        ...
        ("confirm_idd_driver_tip", "Die Option zur Installation des virtuellen Anzeigetreibers ist aktiviert. Beachten Sie, dass ein Testzertifikat installiert wird, um dem virtuellen Anzeigetreiber zu vertrauen. Dieses Testzertifikat wird nur verwendet, um HkRemoto-Treibern zu vertrauen."),
        ...
        ("verify_HkRemoto_password_tip", "HkRemoto-Passwort bestätigen"),
